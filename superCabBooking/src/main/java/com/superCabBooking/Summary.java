...
public class Summary {
	JFrame summary = new JFrame("Booking Details");
	...
	Summary(String driverName, String vehiclenumString, String phoneNo, Double Fare, int hours, int minutes,
			double Rating, Double travelDist) {// showing assigned details to user
		...
		duration.setText(
				"Estimated Duration: " + String.valueOf(hours) + "hours " + String.valueOf(minutes) + "minutes");
