package MiniProject.Super_Cab_Service.services;

import MiniProject.Super_Cab_Service.enums.Gender;
import MiniProject.Super_Cab_Service.exceptions.CreateException;
import MiniProject.Super_Cab_Service.exceptions.DriverNotAvailableException;
...
public class CabBookingService {
	...
	public Driver registerDriver(String name, int id, Gender gender, Vehicle vehicle, boolean available)
			throws CreateException {
		return userService.registerDriver(name, id, gender, vehicle, available);
	}

	public Rider registerRider(String name, int id, Gender gender, Location fromLocation, Location toLocation)
			throws CreateException {
